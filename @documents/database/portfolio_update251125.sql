...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Nov 24, 2025 at 06:22 PM
...
(1, 1, 'Chulalongkorn University', 'Master\'s Degree', 'Faculty of Engineering', 'Computer Engineering', '2020-08-01', '2022-05-30', 0, 1, 'GPA 3.85'),
(2, 1, 'Kasetsart University', 'Bachelor\'s Degree', 'Faculty of Science', 'Computer Science', '2013-08-02', '2017-05-30', 0, 2, 'GPA 3.65, Second Class Honors'),
(3, 1, 'Bangkok Christian College', 'High School', 'Science and Mathematics Program', 'Science-Math', '2010-05-15', '2013-03-15', 0, 3, 'GPAX 3.50');
...
(1, 'E-Commerce Platform', '/uploads/1/project_1_692460f5a68c5.png', 'Developed a full-featured online shopping platform\r\nImplemented shopping cart and payment gateway integration\r\nCreated admin dashboard for inventory management\r\nBuilt responsive design for mobile and desktop\r\nIntegrated email notification system', 3, 1),
(2, 'Inventory Management System', '/uploads/1/project_1_69246187cf760.png', 'Designed and developed inventory tracking system for retail business\r\nReal-time stock monitoring with barcode scanning\r\nGenerate sales reports and analytics\r\nMulti-user role management system\r\nExport data to Excel and PDF formats', 2, 1),
(3, 'Company Portfolio Website', '/uploads/1/project_1_6924651ddaf17.jpg', 'Created modern and responsive portfolio website\r\nImplemented contact form with email integration\r\nOptimized for search engines (SEO)\r\nFast loading speed with optimized images\r\nAdmin panel for content management', 1, 1);
...
(1, 'Somchai', 'Jaidee', '1995-05-15', 'somchai.j@email.com', 'Somchai123!', '2025-11-24 13:34:31');
