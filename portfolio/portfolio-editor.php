            ...
            <section id="personal" class="personal">
                <form id="personalForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-2">
                        ...
                        <div class="form-group">
                            <label for="position" class="required-label">Professinal Title:</label>
                            <input type="text" id="position" placeholder="e.g., Full Stack Developer, UI/UX Designer" required>
                        </div>
                        <div class="form-group">
