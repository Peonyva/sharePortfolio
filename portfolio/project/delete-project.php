...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $sqlSelect = "SELECT projectImagePath, sortOrder FROM project WHERE id = :id AND userID = :userID";
        ...
        $sqlDelete = "DELETE FROM project WHERE id = :id AND userID = :userID";
        ...
        if ($stmtDelete->execute()) {
            // ✅ ลบไฟล์รูปภาพ
            $filePath = $_SERVER['DOCUMENT_ROOT'] . $project['projectImagePath'];
